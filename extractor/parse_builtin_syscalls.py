...
def parse_builtin_syscall(debug_log_path):
    # suppose /path/to/debug.log has been generated by syz-validator debug
...
def generate_debug_log(fuzzer_path, out_dir):
    ...
    parse_cmd = '%s debug %s'%(syz_validator_bin, out_dir)
...
if __name__ == '__main__':
    ...
    generate_debug_log(args.fuzzer, args.out_dir)
    builtin_syscalls = parse_builtin_syscall(os.path.join(args.out_dir, 'debug.log'))
